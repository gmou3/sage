...
class AlgebraicScheme_subscheme_affine(AlgebraicScheme_subscheme):
    ...
    def multiplicity(self, P):
        ...
        ::
            ...
            sage: C = A.curve([x^8 - y, y^7 - z, z^3 - 1, w^5 - v^3])  # long time      # needs sage.libs.singular sage.schemes
            sage: Q = A([22,1,1,0,0])
            sage: C.multiplicity(Q)  # long time                                        # needs sage.libs.singular sage.schemes
            3
