...
Test all interacts from the Sage interact library::
    ...
    sage: test(interacts.fractals.cellular_automaton)  # long time
    ...
    sage: test(interacts.geometry.unit_circle)  # long time
    ...
    sage: test(interacts.geometry.trigonometric_properties_triangle)  # long time
...
Test matrix control (see :trac:`27735`)::
    ...
    ....:     print(A)
    ....:     print(parent(A))
    sage: test(matrix_test)  # long time
